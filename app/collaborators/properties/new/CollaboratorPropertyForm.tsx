    ...
    <form className="vault-property-form" onSubmit={submit}>
      <section className="vault-panel vault-form-section">
        ...
        <div className="vault-form-grid">
          ...
          <label><span>{listingType === "new-development" ? "Bedrooms from" : "Bedrooms"}</span><input name="bedrooms" type="number" min="0" placeholder="1" /></label>
          {listingType === "new-development" && <label><span>Bedrooms to</span><input name="bedroomsTo" type="number" min="0" placeholder="4" /></label>}
          <label><span>{listingType === "new-development" ? "Bathrooms from" : "Bathrooms"}</span><input name="bathrooms" type="number" min="0" placeholder="1" /></label>
        ...
        {(market === "malaysia" || market === "asia") && (
          <fieldset className="vault-subsection-fieldset">
            ...
            <p>These details will appear on the Asia property carousel after PF EuroAsia approval.</p>
            <div className="vault-form-grid">
              <label>
                <span>Country</span>
                <input key={market} name="country" defaultValue={market === "malaysia" ? "Malaysia" : ""} placeholder="Thailand" required />
              </label>
              <label>
                <span>Setting</span>
