...
export default function MalaysiaCompanyFormationPage() {
  return (
    <main className={styles.page}>
      ...
      <section className={styles.intro}><div className={`site-shell ${styles.introGrid}`}><div><p className="eyebrow">Structure follows activity</p><h2>Start with what the company will actually do.</h2></div><div className={styles.lead}><p>The best jurisdiction is not simply the one with the fastest registration or lowest headline tax. It should fit the customers, contracts, management, banking, employees and owners.</p><p>PF EuroAsia coordinates the initial review and introduces established Malaysian corporate, accounting, immigration and tax specialists for formal advice and implementation.</p><p><Link className="text-link" href="/guides/malaysia-company-vs-labuan-company">Compare a Malaysia company with a Labuan company <span>→</span></Link></p><p><Link className="text-link" href="/guides/labuan-company-setup-costs">Review Labuan setup costs <span>→</span></Link></p></div></div></section>
