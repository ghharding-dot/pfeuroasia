...
export default async function LuxuryVillaRentalsPage({
  ...
  return (
    <main className="villa-rentals-page">
      ...
      />
      <section className="villa-rentals-hero"><Image className="villa-rentals-hero-image" src="/images/hero-villa.webp" alt="Luxury villa rental overlooking the Marbella coast" fill priority sizes="100vw" /><div className="villa-rentals-overlay" /><div className="site-shell villa-rentals-hero-inner"><div className="villa-rentals-hero-copy"><p className="villa-rentals-eyebrow">Luxury villa rentals</p><h1>Exceptional homes.<br /><em>Personal service.</em></h1><p className="villa-rentals-tagline">Complete discretion.</p><p className="villa-rentals-collaboration">Property Facilitators EuroAsia <span>×</span> The Luxury Villa Collection</p><Link className="villa-rentals-button" href="#villa-enquiry">Request your bespoke villa selection <span>→</span></Link><Link className="villa-rentals-selection-link" href="#villa-rentals-collection">View a selection from 100+ villas <span aria-hidden="true">↓</span></Link></div></div></section>
      <section className="villa-rentals-intro" id="villa-rentals-collection"><div className="site-shell villa-rentals-intro-grid"><div><p className="villa-rentals-eyebrow dark">A selection from 100+ villas</p><h2>A glimpse of what is available.</h2></div><div className="villa-rentals-body-copy"><p>The villas shown below are a small selection from our portfolio of more than 100 luxury villas across Marbella and the surrounding prime residential areas. Availability changes frequently, and many exceptional homes are shared privately.</p><p>Send us your dates, number of guests, bedroom requirements, preferred area and approximate budget. We will respond personally with a tailored shortlist to suit your stay.</p></div></div></section>
      ...
      <section className="villa-rentals-enquiry" id="villa-enquiry"><div className="site-shell villa-rentals-enquiry-layout"><div className="villa-rentals-enquiry-copy"><p className="villa-rentals-eyebrow">Private enquiries</p><h2>Request your bespoke villa selection.</h2><p>Our website shows only a selection from more than 100 villas. Share your preferred dates, group size, bedroom requirements, location and approximate budget, and we will respond personally with carefully selected options.</p><ul><li>Confidential, individually managed enquiries</li><li>Access to on-market and privately available villas</li><li>Full concierge support before and during your stay</li></ul></div><RentalEnquiryForm selectedVilla={selectedVilla ? selectedVilla.reference + " — " + selectedVilla.title : ""} /></div></section>
      <Footer />
      <style>{`
