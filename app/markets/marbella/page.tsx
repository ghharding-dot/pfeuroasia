...
export default function MarbellaPage() {
  return <main>
    ...
    <section className="area-advice section-pad"><div className="site-shell area-advice-grid"><div><p className="eyebrow">Beyond the headline areas</p><h2>One coast, many lifestyles.</h2></div><div><p>Our work can extend across Benahavís, the Golden Mile, Nueva Andalucía, Sierra Blanca, Estepona and selected opportunities throughout the wider Costa del Sol.</p><p>Buying from overseas requires more than a property shortlist. Our international buyer guide explains how we structure the search, local advice, professional coordination and private access around the client.</p><Link className="text-link" href="/guides/marbella-property-international-buyers">Read the international buyer guide <span>→</span></Link></div></div></section>
    <Footer />
  </main>;
}
