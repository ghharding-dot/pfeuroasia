...
export default async function MalaysiaPage() {
  ...
  return <main>
    ...
    <section className="china-contact section-pad"><div className="site-shell china-contact-grid"><div><p className="eyebrow">Residency & company formation</p><h2>Build a base<br />in Malaysia.</h2></div><div><p>For international entrepreneurs and families, we coordinate Malaysia and Labuan company formation, work-permit and residency conversations with established local specialists.</p><div className="channel-tags"><span>Malaysia company</span><span>Labuan company</span><span>Residency options</span></div><Link className="button button-dark" href="/guides/malaysia-residency-options">Compare residency options <span>→</span></Link><br /><br /><Link className="text-link" href="/services/malaysia-company-formation">Explore Malaysia company formation <span>→</span></Link><br /><br /><Link className="text-link" href="/guides/buying-property-in-malaysia-as-a-foreigner">Read the foreign-buyer property guide <span>→</span></Link><br /><br /><Link className="text-link" href="/guides/cost-of-living-malaysia-vs-spain">Compare living costs with Spain <span>→</span></Link></div></div></section>
    ...
    <TopicPathway
      title="Plan the Malaysian base in the right order."
      intro="Start with the reason for moving or investing, then connect residency, property, living costs and any company structure around the same facts."
      links={[
        { label: "Relocation", title: "Malaysia residency options", description: "Compare long-stay, remote-work, employment and business-led routes.", href: "/guides/malaysia-residency-options" },
        { label: "Property", title: "Foreign-buyer property guide", description: "Understand state approval, thresholds, title restrictions and due diligence.", href: "/guides/buying-property-in-malaysia-as-a-foreigner" },
        { label: "Living", title: "Malaysia vs Spain living costs", description: "Compare the household budget, including schools, healthcare and travel.", href: "/guides/cost-of-living-malaysia-vs-spain" },
        { label: "Company", title: "Malaysia company formation", description: "Choose a structure that fits the real customers, people and operations.", href: "/services/malaysia-company-formation" },
      ]}
    />
