...
const tickerItems = [
  "NEW SWEDISH PARTNER — Bremberg International Estate has joined the PF EuroAsia collaboration group",
...
export function Header({
  ...
  return (
    <>
      <div className="news-ticker" role="region" aria-label="Latest PF EuroAsia news and market updates">
