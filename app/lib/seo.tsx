...
export const seoPages = {
  ...
  ownersEn: { path: "/property-owners", title: "Sell Your Marbella Property Internationally", description: "Present prime Marbella and Benahavís property to qualified international buyers through discreet positioning and controlled distribution.", locale: "en-GB", group: "owners", breadcrumbs: [["Home", "/"], ["Property owners", "/property-owners"]] },
  ...
  portfolioEn: { path: "/private-portfolio", title: "Private & Off-Market Property Portfolio", description: "Register for confidential access to selected private and discreetly marketed luxury property opportunities in Southern Spain.", locale: "en-GB", group: "portfolio", breadcrumbs: [["Home", "/"], ["Private portfolio", "/private-portfolio"]] },
