...
const groups: Record<string, Partial<Record<SeoLocale, string>>> = {
  ...
  investmentMarbella: { "en-GB": "/investment-property-marbella" },
  azureanMarbella: { "en-GB": "/investment-property-marbella/azurean-residences-benahavis" },
  royalParkResidence: { "en-GB": "/investment-property-marbella/royal-park-residence-resort" },
  theViewMarbella: { "en-GB": "/investment-property-marbella/the-view-marbella" },
  ...
  mm2hMalaysia: { "en-GB": "/guides/mm2h-malaysia" },
  ...
  movingSpainMalaysia: { "en-GB": "/guides/moving-from-spain-to-malaysia" },
  labuanCosts: { "en-GB": "/guides/labuan-company-setup-costs" },
  malaysiaVsLabuan: { "en-GB": "/guides/malaysia-company-vs-labuan-company" },
  costMalaysiaSpain: { "en-GB": "/guides/cost-of-living-malaysia-vs-spain" },
  malaysiaPropertyForeigners: { "en-GB": "/guides/buying-property-in-malaysia-as-a-foreigner" },
  spainVisaAlternatives: { "en-GB": "/guides/spain-golden-visa-alternatives" },
  knowledgeCentre: { "en-GB": "/knowledge-centre" },
...
export const seoPages = {
  ...
  investmentMarbellaEn: { path: "/investment-property-marbella", title: "Investment Property in Marbella & Southern Spain", description: "Explore selected managed, branded and tourist-licensed investment property in Marbella and Benahavís, with clear guidance for international buyers.", locale: "en-GB", group: "investmentMarbella", breadcrumbs: [["Home", "/"], ["Marbella and Benahavís", "/markets/marbella"], ["Investment property", "/investment-property-marbella"]], image: "/images/azurean/azurean-hero.webp", priority: 0.9 },
  azureanMarbellaEn: { path: "/investment-property-marbella/azurean-residences-benahavis", title: "Azurean Marbella | Destination by Hyatt Residences", description: "Explore Azurean Marbella branded residences in Benahavís: tourist-rental licensing, owner use, resort facilities, payment plan and current guide prices.", locale: "en-GB", group: "azureanMarbella", breadcrumbs: [["Home", "/"], ["Investment property", "/investment-property-marbella"], ["Azurean Marbella", "/investment-property-marbella/azurean-residences-benahavis"]], image: "/images/azurean/azurean-hero.webp", priority: 0.9 },
  realDeLaQuintaEn: { path: "/investment-property-marbella/real-de-la-quinta", title: "Real de La Quinta | Benahavís Country Club Resort", description: "Explore Real de La Quinta, a 200-hectare residential country club resort in Benahavís with lake, golf, wellness, hotel, apartments, penthouses and villa plots.", locale: "en-GB", group: "realDeLaQuinta", breadcrumbs: [["Home", "/"], ["Investment property", "/investment-property-marbella"], ["Real de La Quinta", "/investment-property-marbella/real-de-la-quinta"]], image: "https://www.realdelaquinta.com/sites/default/files/styles/16_9_large/public/2022-10/9D9A1207.jpg?itok=gliQ0KAz", priority: 0.9 },
  royalParkResidenceEn: { path: "/investment-property-marbella/royal-park-residence-resort", title: "Royal Park Residence & Resort | New Golden Mile", description: "Explore Royal Park Residence & Resort on Estepona's New Golden Mile: 57 luxury two, three and four-bedroom apartments, resort facilities and a staged payment plan.", locale: "en-GB", group: "royalParkResidence", breadcrumbs: [["Home", "/"], ["Investment property", "/investment-property-marbella"], ["Royal Park Residence & Resort", "/investment-property-marbella/royal-park-residence-resort"]], image: "/images/royal-park/royal-park-hero.webp", priority: 0.9 },
  theViewMarbellaEn: { path: "/investment-property-marbella/the-view-marbella", title: "The View Marbella | Luxury Residences in Benahavís", description: "Explore The View Marbella: 58 two, three and four-bedroom sea-view residences and penthouses in Benahavís, with guide prices from €899,000.", locale: "en-GB", group: "theViewMarbella", breadcrumbs: [["Home", "/"], ["Investment property", "/investment-property-marbella"], ["The View Marbella", "/investment-property-marbella/the-view-marbella"]], image: "/images/the-view-marbella/the-view-hero.webp", priority: 0.9 },
  ...
  mm2hMalaysiaEn: { path: "/guides/mm2h-malaysia", title: "MM2H Malaysia 2026 | Categories, Costs & Property Rules", description: "Compare the 2026 Malaysia My Second Home Silver, Gold, Platinum and SEZ categories, including fixed deposits, property commitments, pass terms and family eligibility.", locale: "en-GB", group: "mm2hMalaysia", breadcrumbs: [["Home", "/"], ["Asia Gateway", "/asia-gateway"], ["Malaysia residency", "/guides/malaysia-residency-options"], ["MM2H guide", "/guides/mm2h-malaysia"]], image: "/images/kl BACK GORUND.avif", priority: 0.95 },
  ...
  movingSpainMalaysiaEn: { path: "/guides/moving-from-spain-to-malaysia", title: "Moving from Spain to Malaysia: Practical Guide", description: "A practical guide for people considering a move from Spain to Malaysia, covering residence, tax residence, housing, healthcare and the order in which to plan.", locale: "en-GB", group: "movingSpainMalaysia", breadcrumbs: [["Home", "/"], ["Asia Gateway", "/asia-gateway"], ["Moving from Spain to Malaysia", "/guides/moving-from-spain-to-malaysia"]], image: "/images/kl BACK GORUND.avif", priority: 0.9 },
  labuanCostsEn: { path: "/guides/labuan-company-setup-costs", title: "Labuan Company Setup Costs: Official Fees & Budget", description: "Understand the official Labuan company fees and the professional, substance, employment-pass and ongoing costs that need separate quotations.", locale: "en-GB", group: "labuanCosts", breadcrumbs: [["Home", "/"], ["Asia Gateway", "/asia-gateway"], ["Labuan company setup costs", "/guides/labuan-company-setup-costs"]], image: "/images/asia-network.webp", priority: 0.9 },
  malaysiaVsLabuanEn: { path: "/guides/malaysia-company-vs-labuan-company", title: "Malaysia Company vs Labuan Company", description: "Compare a mainland Malaysian company and a Labuan company by market, activity, administration, substance, banking and immigration considerations.", locale: "en-GB", group: "malaysiaVsLabuan", breadcrumbs: [["Home", "/"], ["Asia Gateway", "/asia-gateway"], ["Malaysia company vs Labuan company", "/guides/malaysia-company-vs-labuan-company"]], image: "/images/asia-network.webp", priority: 0.9 },
  costMalaysiaSpainEn: { path: "/guides/cost-of-living-malaysia-vs-spain", title: "Cost of Living in Malaysia vs Spain", description: "A decision-led comparison of living costs in Malaysia and Spain, including housing, transport, healthcare, schooling, tax and exchange-rate planning.", locale: "en-GB", group: "costMalaysiaSpain", breadcrumbs: [["Home", "/"], ["Asia Gateway", "/asia-gateway"], ["Malaysia vs Spain living costs", "/guides/cost-of-living-malaysia-vs-spain"]], image: "/images/kl BACK GORUND.avif", priority: 0.9 },
  malaysiaPropertyForeignersEn: { path: "/guides/buying-property-in-malaysia-as-a-foreigner", title: "Buying Property in Malaysia as a Foreigner", description: "A practical guide to foreign property ownership in Malaysia, covering state thresholds, restricted categories, consent, finance and due diligence.", locale: "en-GB", group: "malaysiaPropertyForeigners", breadcrumbs: [["Home", "/"], ["Malaysia", "/markets/malaysia"], ["Buying property as a foreigner", "/guides/buying-property-in-malaysia-as-a-foreigner"]], image: "/images/asia-network.webp", priority: 0.9 },
  spainVisaAlternativesEn: { path: "/guides/spain-golden-visa-alternatives", title: "Spain Golden Visa Alternatives After 2025", description: "The Spanish investor-residence route closed to new applicants in April 2025. Compare current alternatives such as non-lucrative, digital-nomad and work routes.", locale: "en-GB", group: "spainVisaAlternatives", breadcrumbs: [["Home", "/"], ["Marbella and Benahavís", "/markets/marbella"], ["Spain Golden Visa alternatives", "/guides/spain-golden-visa-alternatives"]], image: "/images/hero-villa.webp", priority: 0.9 },
  knowledgeCentreEn: { path: "/knowledge-centre", title: "EuroAsia Knowledge Centre: Malaysia, Labuan & Spain", description: "Practical, source-led guides to Malaysia residency, Labuan and Malaysian companies, property, relocation and Spain–Asia decisions.", locale: "en-GB", group: "knowledgeCentre", breadcrumbs: [["Home", "/"], ["Knowledge Centre", "/knowledge-centre"]], image: "/images/asia-network.webp", priority: 0.95 },
...
export function RouteSeo({ pageKey, children }: { pageKey: SeoPageKey; children: ReactNode }) {
  ...
  const articleGroups = new Set([
    ...
    "malaysiaVsLabuan",
    "costMalaysiaSpain",
    "malaysiaPropertyForeigners",
    "spainVisaAlternatives",
  ]);
